#!/usr/bin/env python3
"""
LCA TV - Application avec Routage Corrigé
...
# Configuration adaptée pour développement et production
...
if os.environ.get('FLASK_ENV') == 'production':
    ...
    # En développement, pas de sous-répertoire
...
# Admin credentials - Réinitialisés
ADMIN_USERS = {
    'admin': 'lcatv2024',  # Administrateur Principal - Réinitialisé
...
def login():
    """Connexion administrateur avec debug amélioré"""
    ...
    if request.method == 'POST':
        ...
        print(f"   • Available users: {list(ADMIN_USERS.keys())}")
        ...
        if username in ADMIN_USERS and ADMIN_USERS[username] == password:
            ...
            # Redirection explicite avec URL complète
...
@login_required
def dashboard():
    """Dashboard administrateur avec debug"""
    print(f"���� DASHBOARD ACCESS")
    print(f"   • User in session: {session.get('user', 'None')}")
    ...
    settings = {
        'site_title': 'LCA TV',
        'site_description': 'La chaîne au cœur de l\'Afrique',
    ...
    print(f"   ✅ Rendering dashboard for {session.get('user')}")
...
@app.route('/health')
def health_check():
    """Health check avec informations de session"""
    return jsonify({
        'status': 'healthy',
...
if __name__ == '__main__':
    print("🚀 Démarrage de LCA TV - Version avec Routage Corrigé")
    print("=" * 60)
    print("🌐 Site Public:")
    print("   • Accueil: http://localhost:5004/")
    print("   • Vidéos: http://localhost:5004/videos")
    print("   • Live: http://localhost:5004/live")
    print()
    ...
    print("   • Debug: http://localhost:5004/debug")
    print("   • Test Session: http://localhost:5004/test-session")
    print()
