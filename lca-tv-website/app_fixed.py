...
def debug_info():
    ...
    return f"""
    <html>
    <head><title>LCA TV Debug Info - FIXED VERSION</title></head>
    <body>
        <h1>LCA TV Debug Information - FIXED VERSION</h1>
        ...
        <p><strong>Logo Test:</strong> <img src="{url_for('static', filename='images/LOGO LCA.png')}" alt="Logo Test" style="max-height: 50px;"></p>
        <p><strong>Logo URL:</strong> {url_for('static', filename='images/LOGO LCA.png')}</p>
        ...
        <ul>
            <li><a href="{url_for('static', filename='images/LOGO LCA.png')}" target="_blank">Logo (url_for)</a></li>
            <li><a href="/lca/static/images/LOGO LCA.png" target="_blank">Logo (direct path)</a></li>
        </ul>
    </body>
    </html>
    """
